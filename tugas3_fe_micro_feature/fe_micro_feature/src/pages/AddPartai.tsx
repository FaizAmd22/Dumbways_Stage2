...
const AddPartai: React.FC = () => {
    ...
    <>
        ...
        <div className="bg-white w-full h-screen pt-[64px] flex items-center flex-col justify-center">
            <h1 className="uppercase font-bold text-3xl">ADD partai</h1>
            ...
            {imageUrl ? (
                ...
                <form action="/" className="flex flex-col gap-5">
                        ...
                        <div className="text-start flex flex-col">
                            <label htmlFor="ketua">Ketua Umum</label>
                            <input type="text" name="ketua" className="border rounded-md" />
                        </div>
                        
                        <div className="text-start flex flex-col">
                            <label htmlFor="visi">Visi Misi</label>
                            <textarea type="textarea" name="visi" className="border rounded-md h-[10vh]" />
                        </div>
                        
                        <div className="text-start flex flex-col">
                            <label htmlFor="alamat">Alamat</label>
                            <textarea type="text" name="alamat" className="border rounded-md h-[10vh]" />
                        </div>
